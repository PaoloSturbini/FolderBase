...
enum LocalizedStrings {
    ...
    static let table: [String: (it: String, en: String)] = [
        ...
        "settings.contentIndexing.title": ("Indicizzazione A.I.", "A.I. Indexing"),
        ...
        "settings.contentIndexing.subtitle": ("Un indice separato per ogni cartella principale", "A separate index for each main folder"),
        "settings.indexing.subtitle": ("Motori, chat ed esclusioni", "Engines, chat and exclusions"),
        ...
        "indexing.folders.card": ("Cartelle principali e stato degli indici", "Main folders and index status"),
        ...
        "ai.exclusions.card": ("Fonti escluse dall’AI", "Sources excluded from AI"),
        "ai.exclusions.folder": ("Cartella principale", "Main folder"),
        "ai.exclusions.perFolderIntro": ("Scegli una cartella principale e indica quali file o sottocartelle non devono essere indicizzati né utilizzati dalla chat AI.", "Choose a main folder and specify which files or subfolders must not be indexed or used by AI chat."),
        "ai.exclusions.emptyForFolder": ("Nessuna fonte esclusa per questa cartella.", "No excluded sources for this folder."),
        "ai.exclusions.intro": ("Aggiungi file o cartelle che non devono essere indicizzati, trovati nella ricerca per contenuto o usati come fonti dalla chat. Una cartella esclude anche tutto il suo contenuto.", "Add files or folders that must not be indexed, found in content search, or used as chat sources. A folder also excludes all of its contents."),
        "ai.exclusions.addFiles": ("Aggiungi file", "Add files"),
        "ai.exclusions.addFolders": ("Aggiungi cartelle", "Add folders"),
        "ai.exclusions.empty": ("Nessuna esclusione personalizzata.", "No custom exclusions."),
        "ai.exclusions.remove": ("Rimuovi esclusione", "Remove exclusion"),
        "ai.exclusions.missing": ("Elemento non disponibile", "Item unavailable"),
        "ai.exclusions.analyze": ("Analizza cartelle gestite", "Analyze managed folders"),
        "ai.exclusions.analyzing": ("Analisi in corso…", "Analyzing…"),
        "ai.exclusions.addAllSuggestions": ("Aggiungi tutti", "Add all"),
        "ai.exclusions.suggestionNote": ("FolderBase ignora già automaticamente gli elementi nascosti durante l’indicizzazione. L’analisi li mostra comunque, insieme a cartelle tecniche o generate, così puoi rendere esplicite le esclusioni. Nessun suggerimento viene applicato senza conferma.", "FolderBase already ignores hidden items during indexing. The analysis still shows them, together with technical or generated folders, so you can make exclusions explicit. No suggestion is applied without confirmation."),
        "ai.exclusions.reason.hidden": ("Cartella nascosta", "Hidden folder"),
        "ai.exclusions.reason.generated": ("Cartella tecnica o generata", "Technical or generated folder"),
        ...
        "chat.scope.allIndexes": ("Tutti gli indici", "All indexes"),
        "chat.scope.indexes": ("Indici delle cartelle", "Folder indexes"),
        "chat.scope.index": ("Indice", "Index"),
        ...
        "maint.indexCleanupCard": ("Pulizia indici A.I.", "A.I. index cleanup"),
        "maint.indexCleanup": ("Cancella indici orfani", "Delete orphaned indexes"),
        "maint.indexCleanupNote": ("Conserva un solo indice per ogni cartella principale attualmente selezionata, incluse tutte le sue sottocartelle. Elimina gli indici precedenti, quelli di cartelle non più esistenti e quelli creati separatamente per sottocartelle.", "Keeps one index for each currently selected main folder, including all its subfolders. Deletes previous indexes, indexes for folders that no longer exist, and indexes created separately for subfolders."),
        "maint.indexCleanupDone": ("Indici orfani rimossi:", "Orphaned indexes removed:"),
        "maint.indexedFilesRemoved": ("file indicizzati eliminati:", "indexed files removed:"),
        ...
        "ctx.information": ("Informazioni", "Information"),
        ...
        "info.kind": ("Tipo", "Kind"),
        "info.location": ("Posizione", "Location"),
        "info.size": ("Dimensione", "Size"),
        "info.created": ("Creazione", "Created"),
        "info.modified": ("Ultima modifica", "Last modified"),
        "info.access": ("Accesso", "Access"),
        "info.access.read": ("lettura", "read"),
        "info.access.write": ("scrittura", "write"),
        "info.kind.folder": ("Cartella", "Folder"),
        "info.kind.file": ("File", "File"),
        "info.size.folder": ("Contenuto della cartella", "Folder contents"),
